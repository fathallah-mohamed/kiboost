    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'Tu es un chef cuisinier expert qui génère UNIQUEMENT des tableaux JSON de recettes selon le format demandé. Réponds UNIQUEMENT avec un tableau JSON valide, sans texte additionnel ni formatage markdown.'
          },
